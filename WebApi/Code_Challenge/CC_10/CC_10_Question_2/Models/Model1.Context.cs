...
namespace CC_10_Question_2.Models
{
    ...
    public partial class NorthWindDBEntities1 : DbContext
    {
        ...
        [DbFunction("NorthWindDBEntities1", "fn_get_Country")]
        public virtual IQueryable<fn_get_Country_Result> fn_get_Country(string country)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_Country_Result>("[NorthWindDBEntities1].[fn_get_Country](@country)", countryParameter);
        }
    
        [DbFunction("NorthWindDBEntities1", "fn_GetCustomer_ByCountry")]
        public virtual IQueryable<fn_GetCustomer_ByCountry_Result> fn_GetCustomer_ByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetCustomer_ByCountry_Result>("[NorthWindDBEntities1].[fn_GetCustomer_ByCountry](@country)", countryParameter);
        }
